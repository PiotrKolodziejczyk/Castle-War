    ...
    public static void InitializeResources(ref ResourcesToUpgradeLvl resources, string resourcesEnum, params Building[] buildings)
    {
        switch (resourcesEnum)
        {
            ...
            case "WoodTower":
                ...
                resources.woodToUpgradeLvl = 301 - buildings[0].level * buildings[1].level;
            ...
            case "StoneTower":
                ...
                resources.woodToUpgradeLvl = 201 - buildings[0].level * buildings[1].level;
                resources.stoneToUpgradeLvl = 501 - buildings[0].level * buildings[1].level;
                break;
            case "GreatTower":
                resources.clayToUpgradeLvl = 401 - buildings[0].level * buildings[1].level;
                resources.woodToUpgradeLvl = 201 - buildings[0].level * buildings[1].level;
                resources.stoneToUpgradeLvl = 501 - buildings[0].level * buildings[1].level;
                break;
            case "Barrack":
                ...
                resources.stoneToUpgradeLvl = 401 * buildings[0].level - (buildings[1].level / 2);
                break;
            case "TownHall":
                resources.clayToUpgradeLvl = 301 * buildings[0].level;
                resources.woodToUpgradeLvl = 301 * buildings[0].level;
                resources.stoneToUpgradeLvl = 200 * buildings[0].level;
                break;
            case "ClayMine":
                resources.clayToUpgradeLvl = 301 * buildings[0].level - (buildings[1].level / 2);
                resources.woodToUpgradeLvl = 301 * buildings[0].level - (buildings[1].level / 2);
                resources.stoneToUpgradeLvl = 401 * buildings[0].level - (buildings[1].level / 2);
                break;
            case "Wall":
                resources.clayToUpgradeLvl = 201 * buildings[0].level - (buildings[1].level / 2); ;
                resources.woodToUpgradeLvl = 211 * buildings[0].level - (buildings[1].level / 2); ;
                resources.stoneToUpgradeLvl = 500 * buildings[0].level - (buildings[1].level / 2); ;
                break;
            case "Quarry":
                resources.clayToUpgradeLvl = 301 * buildings[0].level - (buildings[1].level / 2);
                resources.woodToUpgradeLvl = 201 * buildings[0].level - (buildings[1].level / 2);
                resources.stoneToUpgradeLvl = 501 * buildings[0].level - (buildings[1].level / 2);
                break;
            case "TowerWorkShop":
                resources.clayToUpgradeLvl = 101 * buildings[0].level - (buildings[1].level / 2);
                resources.woodToUpgradeLvl = 301 * buildings[0].level - (buildings[1].level / 2);
                resources.stoneToUpgradeLvl = 411 * buildings[0].level - (buildings[1].level / 2);
                break;
            case "Sawmill":
                resources.clayToUpgradeLvl = 301 * buildings[0].level - (buildings[1].level / 2);
            ...
            case "Smithy":
                resources.clayToUpgradeLvl = 301 * buildings[0].level - (buildings[1].level / 2);
                resources.woodToUpgradeLvl = 501 * buildings[0].level - (buildings[1].level / 2);
                resources.stoneToUpgradeLvl = 211 * buildings[0].level - (buildings[1].level / 2);
                break;
        }
    }
